...
class Scraper(object):
    ...
    def __init__(self, cookie=None, scraperInstance=None, driver=selenium.webdriver.Chrome, driver_options={}, scroll_pause=0.1, scroll_increment=300, timeout=10):
        LI_AT="AQEDATZKyKEBhCTcAAABemgnz1wAAAF6jDRTXE4AbW8T3bj-qNf6XqSBuAA5HT63i7bk77hgljustEcnuzvfipY1_ys_2eceIeuLJSVeFVD2Dxrp207J2m29tVU0TFkv1_2f7CuLlXpxZLsrVE6V5hn1"
        print("liat")
        ...
        self.login("milishah111317@gmail.com", "mi6111317")
